        ...
        <g id="d-appswrapper">
          <g id="d-app">
            ...
            <g>
              <linearGradient
                ...
                gradientTransform="matrix(1 0 0 -1 0 1900)"
              >
                <stop offset="0" style="stop-color: #1da666" />
                <stop offset="0.2302" style="stop-color: #20aa7c" />
                <stop offset="0.4367" style="stop-color: #29b47f" />
                <stop offset="0.634" style="stop-color: #38c790" />
                <stop offset="0.8245" style="stop-color: #4de0a3" />
                <stop offset="1" style="stop-color: #66ffbf" />
              </linearGradient>
              <path
                fill="url(#SVGID_9_)"
            ...
            l47.6-28.3c0,0,2.3-1.4,2.5-3.4C612.8,416.2,612.7,416.3,612.3,414.1z"
              ...
              <linearGradient
                ...
                gradientTransform="matrix(1 0 0 -1 0 1900)"
              >
                <stop offset="0" style="stop-color: #45e69b" />
                <stop offset="1" style="stop-color: #3dffae" />
              </linearGradient>
              <path
                fill="url(#SVGID_10_)"
          ...
          c0,3.4,0.3,5,3.6,6.7l46.4,27.5c0,0,7.1,4,14.6,0.1l47.6-28.6C609.8,406.9,612.7,405.4,612.2,401.4z"
            ...
            <g>
              ...
              <circle fill="#48e6a9" cx="581.8" cy="310.5" r="0.7" />
              ...
              <circle fill="#48e6a9" cx="604.2" cy="357.9" r="1.4" />
              <circle fill="#FFFFFF" cx="521.8" cy="341" r="0.7" />
              <circle fill="#48e6a9" cx="506.9" cy="322" r="0.7" />
              <circle fill="#48e6a9" cx="513" cy="361.5" r="0.7" />
              <circle fill="#48e6a9" cx="554.8" cy="313.4" r="1" />
              <circle fill="#48e6a9" cx="539.3" cy="341.7" r="1.4" />
        ...
        <g id="d-apps2wrapper">
          ...
          <g>
            ...
            <g>
              ...
              <circle fill="#48e6a9" cx="1277.5" cy="771.4" r="0.7" />
              ...
              <circle fill="#48e6a9" cx="1300" cy="818.8" r="1.4" />
              <circle fill="#FFFFFF" cx="1217.5" cy="801.9" r="0.7" />
              <circle fill="#48e6a9" cx="1202.6" cy="782.9" r="0.7" />
              <circle fill="#48e6a9" cx="1208.8" cy="822.4" r="0.7" />
              <circle fill="#48e6a9" cx="1250.5" cy="774.3" r="1" />
              <circle fill="#48e6a9" cx="1235.1" cy="802.6" r="1.4" />
  ...
  RK5CYII="
      ...
      555.6,608.9 		"
          ...
          >
            ...
            <stop
              offset="0.2113"
              style="stop-color: #d7ffee; stop-opacity: 0.2113"
            />
            <stop
              offset="0.4448"
              style="stop-color: #b1ffe8; stop-opacity: 0.4448"
            />
            <stop
              offset="0.6617"
              style="stop-color: #96ffdf; stop-opacity: 0.6617"
            />
            <stop
              offset="0.8535"
              style="stop-color: #86ffd7; stop-opacity: 0.8535"
            />
            <stop offset="1" style="stop-color: #80ffd5" />
          </linearGradient>
          <polygon
            class="particlespoly"
            fill="url(#SVGID_42_)"
      ...
      492.7,577.2 		"
        ...
        <g id="redblocksparticles">
          <g>
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop offset="0" style="stop-color: #b3ffe6; stop-opacity: 0" />
              <stop offset="1" style="stop-color: #b3ffe6" />
            </linearGradient>
            <polygon
              fill="url(#SVGID_91_)"
        ...
        1141.3,409 			"
            ...
            <g>
              ...
              <circle cx="1143.5" cy="454.4" r="0.7" fill="#48e6a9" />
              ...
              <circle cx="1166" cy="501.8" r="1.4" fill="#48e6a9" />
              <circle cx="1083.5" cy="484.9" r="0.7" fill="#FFFFFF" />
              <circle cx="1068.6" cy="465.9" r="0.7" fill="#48e6a9" />
              <circle cx="1074.8" cy="505.4" r="0.7" fill="#48e6a9" />
              <circle cx="1116.5" cy="457.3" r="1" fill="#48e6a9" />
              <circle cx="1101.1" cy="485.6" r="1.4" fill="#48e6a9" />
          ...
          <g>
            ...
            <g>
              ...
              <circle cx="827.5" cy="642.4" r="0.7" fill="#48e6a9" />
              ...
              <circle cx="850" cy="689.8" r="1.4" fill="#48e6a9" />
              <circle cx="767.5" cy="672.9" r="0.7" fill="#FFFFFF" />
              <circle cx="752.6" cy="653.9" r="0.7" fill="#48e6a9" />
              <circle cx="758.8" cy="693.4" r="0.7" fill="#48e6a9" />
              <circle cx="800.5" cy="645.3" r="1" fill="#48e6a9" />
              <circle cx="785.1" cy="673.6" r="1.4" fill="#48e6a9" />
          ...
          <g>
            ...
            <g>
              ...
              <circle cx="668.5" cy="735.4" r="0.7" fill="#48e6a9" />
              ...
              <circle cx="691" cy="782.8" r="1.4" fill="#48e6a9" />
              <circle cx="608.5" cy="765.9" r="0.7" fill="#FFFFFF" />
              <circle cx="593.6" cy="746.9" r="0.7" fill="#48e6a9" />
              <circle cx="599.8" cy="786.4" r="0.7" fill="#48e6a9" />
              <circle cx="641.5" cy="738.3" r="1" fill="#48e6a9" />
              <circle cx="626.1" cy="766.6" r="1.4" fill="#48e6a9" />
          ...
          <g>
            ...
            <g>
              ...
              <circle cx="513.5" cy="828.4" r="0.7" fill="#48e6a9" />
              ...
              <circle cx="536" cy="875.8" r="1.4" fill="#48e6a9" />
              <circle cx="453.5" cy="858.9" r="0.7" fill="#FFFFFF" />
              <circle cx="438.6" cy="839.9" r="0.7" fill="#48e6a9" />
              <circle cx="444.8" cy="879.4" r="0.7" fill="#48e6a9" />
              <circle cx="486.5" cy="831.3" r="1" fill="#48e6a9" />
              <circle cx="471.1" cy="859.6" r="1.4" fill="#48e6a9" />
      ...
      l-0.8-1.3L1524.4,178.1z"
        ...
        <g id="firstBlock">
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0" style="stop-color: #1ba97e" />
            <stop offset="0.2857" style="stop-color: #1fb286" />
            <stop offset="0.75" style="stop-color: #2bca8d" />
            <stop offset="1" style="stop-color: #32daa2" />
          </linearGradient>
          <polygon
            fill="url(#SVGID_49_)"
          ...
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0" style="stop-color: #99ffd8" />
            <stop offset="0.1701" style="stop-color: #7bf2ba" />
            <stop offset="0.4158" style="stop-color: #55e3a8" />
            <stop offset="0.6441" style="stop-color: #3ad79b" />
            <stop offset="0.8458" style="stop-color: #2ad099" />
            <stop offset="1" style="stop-color: #24ce95" />
          </linearGradient>
          <polygon
            fill="url(#SVGID_50_)"
          ...
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0" style="stop-color: #48e6a9" />
            <stop offset="5.850000e-02" style="stop-color: #45e4a2" />
            <stop offset="0.6415" style="stop-color: #2dd48e" />
            <stop offset="1" style="stop-color: #24ce95" />
          </linearGradient>
          <polygon
            fill="url(#SVGID_51_)"
          ...
          >
            <stop offset="0" style="stop-color: #ffffff" />
            <stop offset="0.2713" style="stop-color: #bafde1" />
            <stop offset="0.5184" style="stop-color: #83fbcd" />
            <stop offset="0.7299" style="stop-color: #5bf9bc" />
            <stop offset="0.8974" style="stop-color: #43f8ad" />
            <stop offset="1" style="stop-color: #3af8af" />
          </linearGradient>
          <polygon
            fill="url(#SVGID_52_)"
  ...
  CzAAqYTVOPWO2yYAAAAASUVORK5CYII="
        ...
        955,672.8 		"
          ...
          <linearGradient
            ...
            gradientTransform="matrix(0.3592 -0.3065 -1.2019 -0.6834 1880.408 1551.1382)"
          >
            <stop offset="0" style="stop-color: #80ffce" />
            <stop
              offset="0.3874"
              style="stop-color: #b2ffe5; stop-opacity: 0.5873"
            />
            <stop
              offset="0.9388"
              style="stop-color: #ffffff; stop-opacity: 0"
